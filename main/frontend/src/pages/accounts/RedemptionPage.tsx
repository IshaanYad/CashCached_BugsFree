...
export function RedemptionPage() {
  ...
  const { formatConvertedTokens, preferredCurrency } =
          ...
          <CardContent className="pt-6 flex gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-yellow-900">
                Penalty: {formatConvertedTokens(enquiry.penaltyAmount, preferredCurrency)}
              </p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold text-emerald-600">
              +{formatConvertedTokens(enquiry.accruedInterest, preferredCurrency)}
            </p>
          ...
          <Card>
            ...
            <CardContent>
              <p className={penaltyClass}>
                {penaltyAmount > 0 ? `-${formatConvertedTokens(penaltyAmount, preferredCurrency)}` : formatConvertedTokens(0, preferredCurrency)}
              </p>
              <p className="text-xs text-muted-foreground mt-1">
                {penaltyDescription}
              </p>
              ...
              <div className="space-y-2">
                <p>
                  ...
                  <span className="font-bold text-primary">
                    {formatConvertedTokens(enquiry.netPayableAmount, preferredCurrency)}
                  </span>
                </p>
                {isPremature && (
